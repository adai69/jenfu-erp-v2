...
> = {
  ...
  brands: { label: "品牌", description: "品牌 / 製造商資訊" },
  countries: { label: "國家", description: "國別 / 幣別 / 區域" },
  purchaseMethods: { label: "採購方式", description: "採購策略與流程" },
...
const ROLE_PERMISSION_MATRIX: Record<RoleId, PermissionProfile> = {
  admin: {
    ...
    brands: ["view", "create", "update", "disable"],
    countries: ["view", "create", "update", "disable"],
