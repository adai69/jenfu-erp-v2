...
export const brands: Brand[] = [
  {
    ...
    countryCode: "TW",
    status: "active",
    website: "https://www.jenfu.com.tw",
    description: "內部自有品牌",
    sortOrder: 10,
  },
  {
...
export const sequences: Sequence[] = [
  ...
  { key: "PURCHASE_METHOD", prefix: "PMT", padding: 3, nextNumber: 4, scope: "採購方式" },
...
export const materials: Material[] = [
  {
    ...
    preferredSupplierCode: "SUP0001",
     purchaseMethodCode: "PMT001",
    purchaseLeadTimeDays: 12,
    stdCost: 4500,
    currency: "TWD",
    status: "active",
    isStocked: true,
    description: "標準下軸承座，附工程圖附件說明。",
    note: "標準採購件，適用油水分離機 BS 系列",
    searchKeywords: ["BS3X5", "標準件", "軸承座"],
    createdByName: "系統管理員",
    isVariant: false,
  },
  {
    ...
    purchaseMethodCode: "PMT002",
    purchaseLeadTimeDays: 20,
    status: "active",
    isStocked: false,
    description: "訂製件，採特殊採購流程。",
    note: "訂製件，目前僅供案號 2025-BS-021 使用",
    searchKeywords: ["絞爪", "訂製件"],
    baseCode: "PM-00001",
    isVariant: false,
  },
  {
    ...
    purchaseMethodCode: "PMT003",
    purchaseLeadTimeDays: 15,
    stdCost: 1800,
    currency: "TWD",
    status: "active",
    isStocked: true,
    description: "需低溫存放，定期補貨。",
    note: "採購品，需低溫存放",
    searchKeywords: ["除油劑", "耗材"],
    isVariant: false,
  },
  {
    code: "PM-00001-00001",
...
export const purchaseMethods: PurchaseMethod[] = [
  ...
  },
  {
    ...
    status: "active",
    description: "需提供圖面或料件委外加工，含送件與收件。",
    sortOrder: 20,
  },
  {
    code: "PMT003",
